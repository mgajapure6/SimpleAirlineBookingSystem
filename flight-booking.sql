...
INSERT INTO CUSTOMER(PASSPORTNO,FNAME,M,LNAME,ADDRESS,PHONE,AGE,SEX)
...
INSERT INTO EMPLOYEE(SSN, FNAME, M, LNAME, ADDRESS, PHONE, AGE, SEX, JOBCATEGORY, ASTYPE, ETYPE, SHIFT, POSITION, AP_NAME)
...
--INSERTING VALUES INTO TABLE: JOBCATEGORY--
INSERT INTO JOBCATEGORY(JOBTYPE, SALARY)VALUES('ADMINISTRATIVE SUPPORT',50000);
INSERT INTO JOBCATEGORY(JOBTYPE, SALARY)VALUES('ENGINEER',70000);
INSERT INTO JOBCATEGORY(JOBTYPE, SALARY)VALUES('TRAFFIC MONITOR',80000);
INSERT INTO JOBCATEGORY(JOBTYPE, SALARY)VALUES('AIRPORT AUTHORITY',90000);
...
--INSERTING INTO TABLE: TICKETBOOKING--
INSERT INTO TICKETBOOKING(TICKET_NUMBER, SOURCE, DESTINATION, DATE_OF_BOOKING, DATE_OF_CANCELLATION, DATE_OF_TRAVEL, SEATNO, CLASS, PID, PASSPORTNO, PRICE)
VALUES(0011234111122,'BOM','DFW','11-MAY-16','','15-DEC-16','32A','ECONOMY',1,'A1234568',9500);

INSERT INTO TICKETBOOKING(TICKET_NUMBER, SOURCE, DESTINATION, DATE_OF_BOOKING, DATE_OF_CANCELLATION, DATE_OF_TRAVEL, SEATNO, CLASS, PID, PASSPORTNO, PRICE)
VALUES(0984567222299,'JFK','BOM','11-JUN-16','10-DEC-16','20-DEC-16','45D','ECONOMY',2,'B9876541',10000);

INSERT INTO TICKETBOOKING(TICKET_NUMBER, SOURCE, DESTINATION, DATE_OF_BOOKING, DATE_OF_CANCELLATION, DATE_OF_TRAVEL, SEATNO, CLASS, PID, PASSPORTNO, PRICE)
VALUES(1768901333273,'IAH','DEL','21-AUG-16','','25-DEC-16','1A','BUSINESS',3,'C2345698',11000);

INSERT INTO TICKETBOOKING(TICKET_NUMBER, SOURCE, DESTINATION, DATE_OF_BOOKING, DATE_OF_CANCELLATION, DATE_OF_TRAVEL, SEATNO, CLASS, PID, PASSPORTNO, PRICE)
VALUES(5890987441464,'IXC','IAH','10-AUG-16','','12-JAN-17','20C','FIRST-CLASS',4,'D1002004',15000);

INSERT INTO TICKETBOOKING(TICKET_NUMBER, SOURCE, DESTINATION, DATE_OF_BOOKING, DATE_OF_CANCELLATION, DATE_OF_TRAVEL, SEATNO, CLASS, PID, PASSPORTNO, PRICE)
VALUES(1577654664266,'JFK','TPA','13-JUN-16','','10-DEC-16','54E','ECONOMY',5,'X9324666',7500);

INSERT INTO TICKETBOOKING(TICKET_NUMBER, SOURCE, DESTINATION, DATE_OF_BOOKING, DATE_OF_CANCELLATION, DATE_OF_TRAVEL, SEATNO, CLASS, PID, PASSPORTNO, PRICE)
VALUES(2206543545545,'BOM','DFW','11-NOV-16','','12-FEB-17','43B','ECONOMY',6,'B8765430',3600);

INSERT INTO TICKETBOOKING(TICKET_NUMBER, SOURCE, DESTINATION, DATE_OF_BOOKING, DATE_OF_CANCELLATION, DATE_OF_TRAVEL, SEATNO, CLASS, PID, PASSPORTNO, PRICE)
VALUES(7064321779737,'IAH','DEL','15-NOV-16','','25-DEC-16','27B','FIRST-CLASS',7,'J9801235',9000);

INSERT INTO TICKETBOOKING(TICKET_NUMBER, SOURCE, DESTINATION, DATE_OF_BOOKING, DATE_OF_CANCELLATION, DATE_OF_TRAVEL, SEATNO, CLASS, PID, PASSPORTNO, PRICE)
VALUES(1571357215116,'SFO','FRA','15-OCT-16','','18-DEC-16','34E','ECONOMY',8,'A1122334',7300);

INSERT INTO TICKETBOOKING(TICKET_NUMBER, SOURCE, DESTINATION, DATE_OF_BOOKING, DATE_OF_CANCELLATION, DATE_OF_TRAVEL, SEATNO, CLASS, PID, PASSPORTNO, PRICE)
VALUES(1570864987655,'IXC','IAH','12-NOV-16','','30-DEC-16','54C','ECONOMY',9,'Q1243567',5300);

INSERT INTO TICKETBOOKING(TICKET_NUMBER, SOURCE, DESTINATION, DATE_OF_BOOKING, DATE_OF_CANCELLATION, DATE_OF_TRAVEL, SEATNO, CLASS, PID, PASSPORTNO, PRICE)
VALUES(1579283997799,'BOM','SFO','22-JAN-16','','15-DEC-16','38A','ECONOMY',10,'S1243269',8400);

INSERT INTO TICKETBOOKING(TICKET_NUMBER, SOURCE, DESTINATION, DATE_OF_BOOKING, DATE_OF_CANCELLATION, DATE_OF_TRAVEL, SEATNO, CLASS, PID, PASSPORTNO, PRICE)
VALUES(1255701876107,'FRA','DEL','19-OCT-16','','31-DEC-16','57F','ECONOMY',11,'E3277889',9300);

INSERT INTO TICKETBOOKING(TICKET_NUMBER, SOURCE, DESTINATION, DATE_OF_BOOKING, DATE_OF_CANCELLATION, DATE_OF_TRAVEL, SEATNO, CLASS, PID, PASSPORTNO, PRICE)
VALUES(1251334499699,'IXC','IAH','20-NOV-16','','12-JAN-17','45D','ECONOMY',12,'K3212322',4900);

INSERT INTO TICKETBOOKING(TICKET_NUMBER, SOURCE, DESTINATION, DATE_OF_BOOKING, DATE_OF_CANCELLATION, DATE_OF_TRAVEL, SEATNO, CLASS, PID, PASSPORTNO, PRICE)
VALUES(1258776199490,'BOM','DFW','13-MAY-16','25-MAY-16','15-DEC-16','37C','ECONOMY',13,'P3452390',9600);

INSERT INTO TICKETBOOKING(TICKET_NUMBER, SOURCE, DESTINATION, DATE_OF_BOOKING, DATE_OF_CANCELLATION, DATE_OF_TRAVEL, SEATNO, CLASS, PID, PASSPORTNO, PRICE)
VALUES(5891155114477,'FRA','DEL','26-JUN-16','','23-DEC-16','55C','ECONOMY',14,'W7543336',7900);

INSERT INTO TICKETBOOKING(TICKET_NUMBER, SOURCE, DESTINATION, DATE_OF_BOOKING, DATE_OF_CANCELLATION, DATE_OF_TRAVEL, SEATNO, CLASS, PID, PASSPORTNO, PRICE)
VALUES(5893069766787,'BOM','DFW','11-AUG-16','','22-DEC-16','33F','ECONOMY',15,'R8990566',7100);
